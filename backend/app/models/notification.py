...
class NotificationType(str, enum.Enum):
    ...
    BLOOD_REQUEST_RESPONSE = "BLOOD_REQUEST_RESPONSE"
    BLOOD_REQUEST_FULFILLED = "BLOOD_REQUEST_FULFILLED"
    BLOOD_REQUEST_MODERATED = "BLOOD_REQUEST_MODERATED"
    BLOOD_DONATION_CLAIMED = "BLOOD_DONATION_CLAIMED"
    BLOOD_DONATION_VERIFIED = "BLOOD_DONATION_VERIFIED"
    BLOOD_DONATION_DISPUTED = "BLOOD_DONATION_DISPUTED"
    BLOOD_DONATION_RATED = "BLOOD_DONATION_RATED"
