    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      ...
      {successResponse ? (
        ...
        <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm overflow-hidden">
          {/* Top Banner */}
          <div className="border-b border-zinc-100 dark:border-zinc-800 bg-gradient-to-r from-red-600/10 via-amber-500/5 to-transparent p-4 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-8 space-y-8 text-xs">
            {error && (
            ...
            {/* Submit Action */}
            <div className="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 pt-4 border-t border-zinc-100 dark:border-zinc-800">
              <Link
                href="/missing-person"
                className="w-full sm:w-auto rounded-xl border border-zinc-300 dark:border-zinc-700 px-5 py-2.5 font-semibold text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 transition min-h-[44px] flex items-center justify-center text-center"
              >
                Cancel
              </Link>
              <button
                type="submit"
                disabled={submitting}
                className="w-full sm:w-auto rounded-xl bg-red-600 hover:bg-red-500 px-6 py-2.5 font-bold text-white transition shadow-sm disabled:opacity-50 min-h-[44px] flex items-center justify-center gap-2 cursor-pointer"
              >
                {submitting ? (
                  <>
